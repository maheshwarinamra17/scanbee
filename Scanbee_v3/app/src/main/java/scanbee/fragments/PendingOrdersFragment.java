...
public class PendingOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout  = inflater.inflate(R.layout.fragment_pending_orders, container, false);
    ...
    public void prepareRecyclerView(View parentLayout){
        mRecyclerView = (RecyclerView) parentLayout.findViewById(R.id.pending_orders_recycler_view);
